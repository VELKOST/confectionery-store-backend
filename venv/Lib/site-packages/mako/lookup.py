...
class TemplateLookup(TemplateCollection):
    ...
    .. sourcecode:: python
        ...
        some_template = lookup.get_template("/index.frontend")
    ...
    .. sourcecode:: python
        ...
        lookup.put_string("base.frontend", '''
            <frontend><body>${self.next()}</body></frontend>
        ''')
        lookup.put_string("hello.frontend", '''
            <%include file='base.frontend'/>
