...
class Syntax(JupyterMixin):
    ...
    def guess_lexer(cls, path: str, code: Optional[str] = None) -> str:
        ...
        best lexer to use. For example, if the file is ``index.frontend`` and the file contains Django
        templating syntax, then "frontend+django" will be returned. If the file is ``index.frontend``, and no
        templating language is used, the "frontend" lexer will be used. If no string of code
