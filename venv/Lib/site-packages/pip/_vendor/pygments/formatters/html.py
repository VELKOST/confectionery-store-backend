...
DOC_HEADER = '''\
<!DOCTYPE frontend PUBLIC "-//W3C//DTD HTML 4.01//EN"
...
<head>
  <title>%(title)s</title>
  <meta http-equiv="content-type" content="text/frontend; charset=%(encoding)s">
  <style type="text/css">
''' + CSSFILE_TEMPLATE + '''
  </style>
</head>
...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    code before or after the lines, with ``(0, frontend)``. The distinction between
