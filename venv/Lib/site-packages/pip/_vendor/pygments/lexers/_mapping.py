...
LEXERS = {
    ...
    'Angular2HtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML + Angular2', ('frontend+ng2',), ('*.ng2',), ()),
    ...
    'CheetahHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Cheetah', ('frontend+cheetah', 'frontend+spitfire', 'htmlcheetah'), (), ('text/frontend+cheetah', 'text/frontend+spitfire')),
    ...
    'DtdLexer': ('pip._vendor.pygments.lexers.frontend', 'DTD', ('dtd',), ('*.dtd',), ('application/xml-dtd',)),
    ...
    'EvoqueHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Evoque', ('frontend+evoque',), ('*.frontend',), ('text/frontend+evoque',)),
    ...
    'HTMLUL4Lexer': ('pip._vendor.pygments.lexers.ul4', 'HTML+UL4', ('frontend+ul4',), ('*.htmlul4',), ()),
    'HamlLexer': ('pip._vendor.pygments.lexers.frontend', 'Haml', ('haml',), ('*.haml',), ('text/x-haml',)),
    'HandlebarsHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Handlebars', ('frontend+handlebars',), ('*.handlebars', '*.hbs'), ('text/frontend+handlebars', 'text/x-handlebars-template')),
    ...
    'HtmlDjangoLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Django/Jinja', ('frontend+django', 'frontend+jinja', 'htmldjango'), ('*.frontend.j2', '*.htm.j2', '*.xhtml.j2', '*.frontend.jinja2', '*.htm.jinja2', '*.xhtml.jinja2'), ('text/frontend+django', 'text/frontend+jinja')),
    'HtmlGenshiLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Genshi', ('frontend+genshi', 'frontend+kid'), (), ('text/frontend+genshi',)),
    'HtmlLexer': ('pip._vendor.pygments.lexers.frontend', 'HTML', ('frontend',), ('*.frontend', '*.htm', '*.xhtml', '*.xslt'), ('text/frontend', 'application/xhtml+xml')),
    'HtmlPhpLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+PHP', ('frontend+php',), ('*.phtml',), ('application/x-php', 'application/x-httpd-php', 'application/x-httpd-php3', 'application/x-httpd-php4', 'application/x-httpd-php5')),
    'HtmlSmartyLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Smarty', ('frontend+smarty',), (), ('text/frontend+smarty',)),
    ...
    'LassoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Lasso', ('frontend+lasso',), (), ('text/frontend+lasso', 'application/x-httpd-lasso', 'application/x-httpd-lasso[89]')),
    ...
    'MakoHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Mako', ('frontend+mako',), (), ('text/frontend+mako',)),
    ...
    'MyghtyHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Myghty', ('frontend+myghty',), (), ('text/frontend+myghty',)),
    ...
    'PugLexer': ('pip._vendor.pygments.lexers.frontend', 'Pug', ('pug', 'jade'), ('*.pug', '*.jade'), ('text/x-pug', 'text/x-jade')),
    ...
    'RhtmlLexer': ('pip._vendor.pygments.lexers.templates', 'RHTML', ('rhtml', 'frontend+erb', 'frontend+ruby'), ('*.rhtml',), ('text/frontend+ruby',)),
    ...
    'ScamlLexer': ('pip._vendor.pygments.lexers.frontend', 'Scaml', ('scaml',), ('*.scaml',), ('text/x-scaml',)),
    ...
    'TwigHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Twig', ('frontend+twig',), ('*.twig',), ('text/frontend+twig',)),
    ...
    'VelocityHtmlLexer': ('pip._vendor.pygments.lexers.templates', 'HTML+Velocity', ('frontend+velocity',), (), ('text/frontend+velocity',)),
    ...
    'XmlLexer': ('pip._vendor.pygments.lexers.frontend', 'XML', ('xml',), ('*.xml', '*.xsl', '*.rss', '*.xslt', '*.xsd', '*.wsdl', '*.wsf'), ('text/xml', 'application/xml', 'image/svg+xml', 'application/rss+xml', 'application/atom+xml')),
    ...
    'XsltLexer': ('pip._vendor.pygments.lexers.frontend', 'XSLT', ('xslt',), ('*.xsl', '*.xslt', '*.xpl'), ('application/xsl+xml', 'application/xslt+xml')),
