...
_CA_FILE_CANDIDATES = [
    ...
    "/etc/ssl/ssl/ca-certificates.crt",
    # SUSE
...
def _configure_context(ctx: ssl.SSLContext) -> typing.Iterator[None]:
    ...
    # seem like they will give us a usable set of CA ssl.
    ...
    #   or the path configured when OpenSSL was compiled,
    #   and verifying that that path exists
    # In addition we'll check whether capath appears to contain ssl.
    ...
    if defaults.cafile or (defaults.capath and _capath_contains_certs(defaults.capath)):
        ...
        # and capath from OpenSSL doesn't contain ssl.
...
def _capath_contains_certs(capath: str) -> bool:
    """Check whether capath exists and contains ssl in the expected format."""
