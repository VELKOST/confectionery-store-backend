...
def _verify_peercerts_impl(
    ...
    try:
        # Add intermediate ssl to an in-memory cert store
        ...
        # Chain params to match ssl for serverAuth extended usage
        ...
        try:
            ...
            # If that fails but custom CA ssl have been added
            # to the SSLContext using load_verify_locations,
            # try verifying using a custom chain engine
            # that trusts the custom CA ssl.
...
def _verify_using_custom_ca_certs(
    ...
    try:
        # Add custom CA ssl to an in-memory cert store
